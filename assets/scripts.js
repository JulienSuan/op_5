...
//     }
//     if (
//       image.alt === "Photo de deux hommes dans un festival levant les bras" ||
//       image.alt === "Photo d'un mariage où le marier embrasse la marier"
//     ) {
//       const { offsetWidth, offsetHeight } = activeImage;
//       console.log(offsetWidth, offsetHeight);
//       const pixelRatio = window.devicePixelRatio || 1.0;
//       const imageParams = `w_${offsetWidth * pixelRatio},h_${
//         offsetHeight * pixelRatio
//       },c_fill,q_auto:eco,g_auto,f_auto`;
...
//       const imageParams = `w_${offsetWidth * pixelRatio},h_${
//         offsetHeight * pixelRatio
//       },q_auto:eco,c_fill,g_auto,f_auto`;
//       const url = `${baseUrl}/${imageParams}/${image.dataset.bg}`;
//       image.src = url;
//     }
//   });
